...
export default function Navbar() {
    ...
    const profilePhotoSrc = user?.photo ? `/storage/${user.photo}` : '/vraiLogo.svg';
    ...
    return (
        <>
            <nav
                className={`shadow-accent-lg fixed top-0 left-0 z-50 w-full bg-[#0E1124] text-white backdrop-blur-md transition-transform duration-300 ${
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        {user && (
                            <div className="relative" ref={dropdownRef}>
                                ...
                                <div
                                    className={`absolute right-0 z-50 mt-2 w-56 origin-top rounded-lg border border-gray-800 bg-[#1a1f4b]/95 shadow-xl backdrop-blur-md transition-all duration-200 ease-in-out ${

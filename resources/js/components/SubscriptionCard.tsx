            ...
            >
                ...
                <div className="mt-6 flex items-center justify-center gap-3 sm:gap-4">
                    ...
                    <Switch
                        ...
                        className={`relative inline-flex h-8 w-14 shrink-0 cursor-pointer rounded-full border-2 border-yellow-400 bg-gradient-to-r sm:h-9 sm:w-16 ${
                            abonnement === 'annee' ? 'from-yellow-500 to-yellow-600' : 'from-gray-500 to-gray-600'
                    ...
                    >
                        <span
                            aria-hidden="true"
                            className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow-md ring-0 transition duration-300 ease-in-out sm:h-7 sm:w-7 ${
                                abonnement === 'annee' ? 'translate-x-6 sm:translate-x-7' : 'translate-x-1'
                            }`}
                        />
                    </Switch>

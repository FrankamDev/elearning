...
const CourseCard = ({
 ...
 return (
  <div className="relative flex flex-col justify-between overflow-hidden rounded-xl border border-gray-700 bg-[#0f172a] p-6 shadow-lg transition-transform duration-300 hover:scale-[1.015]">

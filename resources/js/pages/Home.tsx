 ...
 return (
  <>
   <div className="min-h-screen bg-[#020012] text-white">
    ...
    <p className="text-center text-xl">Ils ont commencés comme <span className="text-2xl text-cyan-200 font-serif font-bold">Toi</span>. actuellement ils travaillent ici <span className="font-serif text-2xl">👇👇</span></p>

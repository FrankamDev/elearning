...
//  const lessons = pageProps.lessons?.length ? pageProps.lessons : mockLessons;
//  const auth = pageProps.auth;
...
//    <div className="flex-1 flex flex-col lg:flex-row gap-6 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
//     {/* Left: Course Details */}
//     <motion.aside
//      initial={{ opacity: 0, x: -20 }}
//      animate={{ opacity: 1, x: 0 }}
//      transition={{ duration: 0.5 }}
//      className="w-full lg:w-1/3 bg-white/90 dark:bg-gray-800/90 p-5 sm:p-6 rounded-3xl shadow-lg border border-blue-100 dark:border-gray-700 backdrop-blur-sm"
//     >
...
//       >
//        {isFavorite ? <FaHeart size={18} /> : <FaHeart className="opacity-50" size={18} />}
//       </button>
//      </div>
...
//         className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 text-white font-semibold rounded-xl shadow hover:bg-blue-700 transition text-xs sm:text-sm"
//        >
//         <FaFilePdf className="mr-1 sm:mr-2" /> PDF du Cours
//        </a>
//       )}
//       {cours.externalLink && (
//        <a
...
//         className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-green-600 text-white font-semibold rounded-xl shadow hover:bg-green-700 transition text-xs sm:text-sm"
//        >
//         <FaLink className="mr-1 sm:mr-2" /> Documentation
//        </a>
//       )}
//      </div>
//      <div className="mt-4 p-4 bg-blue-50 dark:bg-gray-700 rounded-xl">
//       <h3 className="text-sm sm:text-base font-semibold text-blue-800 dark:text-blue-300 mb-2">
//        Statistiques
//       </h3>
//       <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">
//        <FaBook className="inline mr-1" /> Leçons : {lessons.length}
//       </p>
//       <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">
...
//       </p>
//       <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">
//        <FaChartBar className="inline mr-1" /> Complétion :{" "}
//        {Math.round(
...
//       className="bg-white/90 dark:bg-gray-800/90 p-5 sm:p-6 rounded-3xl shadow-lg border border-blue-100 dark:border-gray-700 backdrop-blur-sm"
//      >
//       <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-900 dark:text-blue-300 mb-4">
//        <FaBook className="inline mr-2" /> Leçons
//       </h2>
//       {filteredLessons.length === 0 ? (
...
//            animate={{ opacity: 1, y: 0 }}
//            transition={{ duration: 0.3 }}
//            className={`p-4 rounded-xl shadow-md border border-gray-200 dark:border-gray-600 transition-all hover:bg-blue-50 dark:hover:bg-gray-700 cursor-pointer ${selectedLesson?.id === lesson.id ? "bg-blue-100 dark:bg-gray-700" : ""
//             }`}
//            onClick={() => setSelectedLesson(lesson)}
//           >
//            <div className="flex justify-between items-center">
//             <div>
//              <h3 className="text-sm sm:text-base font-semibold text-blue-900 dark:text-blue-300">
//               {lesson.title}
//              </h3>
//              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">
...
//          <motion.button
//           onClick={loadMoreLessons}
//           className="mt-4 w-full sm:w-auto py-2 px-4 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold rounded-xl shadow hover:from-blue-600 hover:to-blue-800 transition flex items-center justify-center gap-2 text-xs sm:text-sm"
//           whileHover={{ scale: 1.05 }}
//           whileTap={{ scale: 0.95 }}
//          >
//           Charger plus <FaChevronDown />
...
//         <video
//          controls
//          className="w-full rounded-xl shadow-md border border-gray-200 dark:border-gray-600 mb-4 sm:mb-6 max-h-[200px] sm:max-h-[300px] md:max-h-[400px] object-cover"
//          src={`/storage/${selectedLesson.video_path}`}
//         >
//          Votre navigateur ne prend pas en charge la vidéo.
//         </video>
//        ) : (
//         <p className="text-gray-500 dark:text-gray-400 italic mb-4 sm:mb-6 text-sm sm:text-base">
//          🎥 Aucune vidéo disponible
//         </p>
//        )}
//        <p className="text-gray-700 dark:text-gray-200 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
//         {selectedLesson.content || "Aucune description disponible."}
//        </p>
...
//           className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 text-white font-semibold rounded-xl shadow hover:bg-blue-700 transition text-xs sm:text-sm"
//          >
//           <FaFilePdf className="mr-1 sm:mr-2" /> PDF de la Leçon
//          </a>
//         )}
...
//        <div>
//         <h3 className="font-bold text-blue-900 dark:text-blue-300 text-base sm:text-lg mb-3 sm:mb-4 flex items-center gap-2">
//          <FaComment /> Commentaires
//         </h3>
//         {auth.user && (
//          <motion.button
...
//           whileTap={{ scale: 0.95 }}
//          >
//           {activeCommentForm === `main-${selectedLesson.id}` ? "Annuler" : "➕ Commenter"}
//          </motion.button>
//         )}

   ...
   <main className="bg-cyan-900 min-h-screen text-gray-100 py-10 px-4 sm:px-6 lg:px-8">
    <div className="max-w-7xl mx-auto">
     ...
     <header className="max-w-4xl mx-auto mb-12 text-center sm:text-left">
      <h1 className="text-4xl font-extrabold tracking-tight mb-4">{cours.title}</h1>
      <p className="text-lg text-cyan-300 leading-relaxed">{cours.description}</p>
     </header>
       ...
       {cours.lessons.map((lesson) => (
        ...
        >
         <div className="flex-1 min-w-0 space-y-4">
          <h3 className="text-2xl font-bold text-white truncate">{lesson.title}</h3>

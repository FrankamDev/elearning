...
//       show: true,
//       isSuccess: true,
//       message: "Commentaire modifié avec succès ! ✍️",
//      });
//      setTimeout(() => setModal({ show: false, isSuccess: false, message: "" }), 3000);
//     },
//     onError: () => {
...
//             ...comment,
//             replies: (comment.replies ?? []).map((reply) =>
//              reply.id === commentId ? { ...reply, content: originalContent } : reply
//             ),
//            };
//           }
//           return comment;
//          })
//          : (lesson.comments ?? []).map((comment) =>
//           comment.id === commentId ? { ...comment, content: originalContent } : comment
//          );
//         return { ...lesson, comments: updatedComments };
//        }
//        return lesson;
...
//       show: true,
//       isSuccess: false,
//       message: "Erreur lors de la modification du commentaire. Réessayez. 😅",
//      });
//      setTimeout(() => setModal({ show: false, isSuccess: false, message: "" }), 3000);
//     },
//    }
...
//      show: true,
//      isSuccess: true,
//      message: "Commentaire supprimé avec succès ! 🗑️",
//     });
//     setTimeout(() => setModal({ show: false, isSuccess: false, message: "" }), 3000);
//    },
//    onError: () => {
...
//      show: true,
//      isSuccess: false,
//      message: "Erreur lors de la suppression du commentaire. Réessayez. 😅",
//     });
//     setTimeout(() => setModal({ show: false, isSuccess: false, message: "" }), 3000);
//    },
//   });
